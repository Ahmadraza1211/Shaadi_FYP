    ...
    <div className="max-w-5xl mx-auto p-6">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl shadow p-12 text-center">
          ...
          <p className="text-gray-600">You have no BNPL applications yet.</p>
              ...
              return (
                <div key={app.application_no} className={`bg-white rounded-2xl shadow p-4 flex items-center justify-between ${urgent ? 'ring-2 ring-red-300' : ''}`}>
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">Order: {app.order_id} • PKR {app.amount.toLocaleString()} • {app.plan_months} months</p>
