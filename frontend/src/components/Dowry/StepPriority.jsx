...
function StepPriority({ formData, categories, updatePriority, updateRedistribution, updateForm }) {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
            ...
            <div
              ...
              className={`border rounded-3xl p-5 transition-all duration-300 relative overflow-hidden ${
                isNotWanted 
                  ...
                  : 'border-purple-100 hover:border-purple-300 bg-white shadow-sm hover:shadow-md'
              }`}
            >
              {/* Category header */}
                  ...
                  <button
                    ...
                    className={`py-2 rounded-xl text-[10px] font-bold border transition-all cursor-pointer ${
                      currentPriority === opt.value
                        ? opt.color + ' border-current ring-1 ring-purple-100'
      ...
      <div className="bg-gradient-to-r from-purple-50/60 to-pink-50/60 border border-purple-100/50 rounded-3xl p-6 relative overflow-hidden">
        <h4 className="text-xs font-extrabold text-purple-900 mb-3 uppercase tracking-wider flex items-center gap-1.5">
          <Star size={14} className="text-purple-600" /> Priority Budget Weights
        </h4>
        <div className="grid grid-cols-4 gap-3 text-center mb-4">
          {[
            ...
            <div key={w.name} className="bg-white rounded-2xl p-3 border border-purple-100/30 shadow-sm">
        ...
        <p className="text-xs text-purple-700/90 leading-relaxed font-medium">
      ...
      <div className="text-center py-2">
        <p className="text-xs text-gray-500 font-medium">
          Ready! Click <strong className="text-purple-600">"Calculate Estimate"</strong> to run the Hybrid Price Engine.
        </p>
      </div>
    </div>
  );
