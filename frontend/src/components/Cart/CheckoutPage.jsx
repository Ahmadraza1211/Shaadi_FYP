    ...
    return (
      <div className="max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-md">
        ...
        <a
          ...
          className="inline-block px-4 py-2 bg-[#a37b3d] hover:bg-[#8a6633] text-white rounded-lg text-sm font-semibold mr-2"
        >
          View Order
        </a>
        <button
          onClick={onClose}
          className="px-4 py-2 border border-gray-300 text-gray-600 rounded-lg text-sm font-semibold"
        >
          Continue Shopping
        </button>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="relative mb-2">
          <input
            ...
            placeholder="Search address (e.g. Gulberg Lahore)"
            value={addressQuery}
        ...
        <input
          className="w-full mb-2 px-3 py-2 border border-gray-200 rounded-lg text-sm"
          placeholder="Street, Area (full address line 1)"
          value={address.line1}
